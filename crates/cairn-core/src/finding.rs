...
pub struct EntityFile {
    pub path: String, pub sha256: Option<String>,
    pub mtime: Option<DateTime<Utc>>,
    pub si_btime: Option<DateTime<Utc>>, pub fn_btime: Option<DateTime<Utc>>,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EntityNetConn {
    pub laddr: String, pub lport: u16,
    pub raddr: Option<String>, pub rport: Option<u16>, pub pid: Option<u32>,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct EntityRegistry {
    pub hive: String, pub key: String, pub value: String, pub data: String,
...
impl Finding {
    pub fn new(severity: Severity, title: impl Into<String>, source: FindingSource) -> Self {
        ...
        Finding {
            ...
            id: Uuid::new_v4(),
            ts: now, detected_at: now,
            severity, title: title.into(), source,
            rule_id: None, rule_author: None, mitre: vec![],
            host: String::new(), user: None, artifact: String::new(),
            entity: Entity::default(), evidence_ref: None,
            details: String::new(), details_client: None, reason: None,
        }
    }
}
